...
public class d20_顺时针打印矩阵 {
    ...
    //一圈是一个循环
    public static ArrayList<Integer> cycPrintMatrix(int[][] matrix) {
    ...
    public static void main(String[] args) {
        ...
        cycPrintMatrix(numbers2);
        System.out.println();
        int[][] numbers3 = {
                {1, 2, 3, 4, 5, 6, 7, 8}
        };
        printMatrixClockWisely(numbers3);
        cycPrintMatrix(numbers3);
        System.out.println();
        int[][] numbers4 = {
                {1, 2, 3, 4, 5, 6, 7, 8},
        ...
        cycPrintMatrix(numbers7);
        System.out.println();
        int[][] numbers8 = {
                {1}
        };
        printMatrixClockWisely(numbers8);
        cycPrintMatrix(numbers8);
        System.out.println();
        // 0个元素的数组
